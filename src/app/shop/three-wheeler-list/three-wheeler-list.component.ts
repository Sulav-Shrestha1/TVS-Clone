...
@Component({
  selector: 'app-three-wheeler-list',
  templateUrl: './three-wheeler-list.component.html',
  styleUrls: ['./three-wheeler-list.component.css']
})
export class ThreeWheelerListComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.trgItem = this.threeWheeler.find(item => {return item.ID === this.id});
